...
public class GoAppEngineSdkType extends SdkType
{
	...
	public void setupSdkPaths(Sdk sdk)
	{
		...
		final VirtualFile librariesRoot = homeDirectory.findFileByRelativePath(String.format("goroot/pkg/%s_%s/", sdkData.TARGET_OS.getName(), sdkData.TARGET_ARCH.getName()));
