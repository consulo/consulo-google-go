...
public abstract class GoParameterInfoHandlerTest extends GoCodeInsightFixtureTestCase
{
	...
	{
		doTest("<html><b>string</b>, interface{}</html>");
	}

	public void testUnnamedAndNamedParameters()
	{
		doTest("<html><b>a string</b>, interface{}</html>");
	}

	public void testFuncParamNone()
	{
	...
	{
		doTest("<html><b>param1 string</b>, param2 int</html>");
	}

	public void testMethParamNone()
	{
		doTest("<html>&lt;no parameters&gt;</html>");
	}

	public void testFieldMethCall()
	{
		doTest("<html><b>a int</b>, b int</html>");
	}

	public void testFuncTypes()
	{
		doTest("<html><b>string</b></html>");
	}

	public void testFunctionTypeByRef()
	{
		doTest("<html><b>intParam int</b></html>");
	}
	...
	public void testFuncParamEllipsis()
	{
		doTest(5, "<html>num int, text string, <b>more ...int</b></html>");
	}

	public void testFuncEmbedInner()
	{
		doTest(1, "<html>num int, <b>text string</b></html>");
	}

	public void testFuncEmbedOuter()
	{
		doTest(2, "<html>a int, b int, <b>c int</b>, d int</html>");
	}

	public void testMethParam()
	{
		doTest(1, "<html>num int, <b>text string</b></html>");
	}
